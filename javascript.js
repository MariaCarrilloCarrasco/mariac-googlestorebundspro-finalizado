...
const welcomeMessageText =
  'Bienvenidxs a Google Store. Las coders del Departamento de Marketing de Google Store queremos que comprar en nuestra página web sea una experiencia positiva. Por ello, queremos ayudar a que las personas sean lo más autónomas posibles y que nuestro servicio sea lo más accesible posible, especialmente para aquellas personas que presentan más dificultades de acceso en un contexto donde las compras online tienen cada vez más auge en el sector. Hemos decidido facilitaros las instrucciones para que podáis adquirir nuestros productos de manera autónoma y, además, disponemos de un teléfono de atención al usuario: 800-900-549. A través de este número os atenderá una persona real, formada y cercana para responder a vuestras consultas de forma personalizada e individualizada, ayudaros a hacer las compras de forma rápida y segura, y también recoger dudas, quejas o sugerencias sobre nuestro servicio. Como veis, somos una entidad comprometida con la atención a las personas, innovadora y con capacidad de adaptación a los cambios constantes. En cuanto a la compra online, primero pinchando en cada producto podéis elegir el diseño que queréis adquirir; a continuación, presionando el botón "Add to Cart" o "Añadir al carrito" aparecerá el número de productos seleccionados, el producto adquirido y el precio total de la compra. Esperamos que sea una experiencia placentera. En el número de teléfono señalado anteriormente, también, encontraréis información sobre la política de cancelación y devolución de productos. Gracias. Saludos, atentamente, Fem Coders Camp de Google Store. P. D.: Cualquier duda, estamos a vuestra disposición. ¡A disfrutar!';
