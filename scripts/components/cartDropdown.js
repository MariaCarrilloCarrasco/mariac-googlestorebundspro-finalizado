    ...
    .map(
      ...
      <div class="cart-dropdown__item" data-product-id="${item.id}">
        ...
        <div class="cart-dropdown__qty">
          <img src="${imgPrefix}/assets/icons/plus-sm.png" alt="plus" class="cart-qty-plus" data-product-id="${item.id}">
          <span class="cart-dropdown__count">${item.count}</span>
          <img src="${imgPrefix}/assets/icons/minus-sm.png" alt="minus" class="cart-qty-minus" data-product-id="${item.id}">
        </div>
      </div>`,
    )
    .join("");
